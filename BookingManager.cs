...
{
    public delegate void EvaluationDelegate(Bookings booking);
    public class BookingManager
    {
        ...
        public void ShowMenu()
        {
            ...
            do
            {
                ...
                if (optionValidate && validOption >= 1 && validOption <= 5)
                {
        ...
        public void CaptureBooking()
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (equip.Length >= 4 && equip.All(c => char.IsLetter(c) || char.IsWhiteSpace(c)))
                    {
                        equipment = equip;
                        break;
                    }
                ...
                // Adding values before we ask a user to input more requests
